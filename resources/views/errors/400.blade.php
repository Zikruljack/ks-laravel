        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow-lg rounded-lg sm:px-10">
                <div class="text-center">
                    <h2 class="text-4xl font-extrabold text-yellow-700">404 - Page Not Found</h2>
                    <p class="mt-4 text-lg text-gray-700">Sorry, the page you are looking for could not be found.</p>
                    <a href="{{ url('/') }}"
